...
--
-- Table structure for table `characters_quest_scenario`
--
...
--
-- Dumping data for table `characters_quest_scenario`
--

LOCK TABLES `characters_quest_scenario` WRITE;
/*!40000 ALTER TABLE `characters_quest_scenario` DISABLE KEYS */;
/*!40000 ALTER TABLE `characters_quest_scenario` ENABLE KEYS */;
UNLOCK TABLES;
